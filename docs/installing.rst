...
`<https://github.com/hyperledger/solang/releases/download/v0.1.13/llvm14.0-linux-x86-64.tar.xz>`_.
...
A pre-built version of LLVM, specifically configured for Solang, is available at
`<https://github.com/hyperledger/solang/releases/download/v0.1.13/llvm14.0-win.zip>`_.
...
`<https://github.com/hyperledger/solang/releases/download/v0.1.13/llvm14.0-mac-intel.tar.xz>`_ and for arm macs there is
`<https://github.com/hyperledger/solang/releases/download/v0.1.13/llvm14.0-mac-arm.tar.xz>`_. After downloading,
